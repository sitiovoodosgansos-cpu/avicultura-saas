...
// Paleta por secao com gradient from -> to + accent (cor solida).
// Usar SEMPRE em todo chart pra manter coerencia visual.
...
// Sequencia harmonica pra charts categoricos com varias fatias/barras
