        ...
        <div className="sticky top-4 rounded-[30px] border border-[color:var(--line)] bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(244,249,255,0.94))] p-5 shadow-[0_18px_50px_rgba(15,23,42,0.08)]">
          <div className="mb-8">
            <div className="flex items-center gap-3">
              <Image
                src="/ornabird-logo.svg"
                alt="Logo Ornabird"
                width={48}
                height={48}
                className="size-12 rounded-2xl border border-white/40 bg-[linear-gradient(135deg,var(--brand),var(--brand-strong))] object-cover shadow-[0_12px_30px_rgba(15,157,138,0.22)]"
              />
              <div>
