...
export function LoginForm({ resetDone = false }: LoginFormProps) {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_top_left,_#ecfeff,_#f8f6f2_50%)] p-4">
      <Card className="w-full max-w-md p-6">
        ...
        <p className="mt-1 text-sm text-zinc-500">Acesse os dados do seu criatorio.</p>
        ...
        <form className="mt-6 space-y-4" onSubmit={onSubmit}>
          ...
          <div className="text-right text-sm">
            <Link href="/forgot-password" className="font-medium text-[#0f766e] hover:underline">
              Esqueci minha senha
            </Link>
          </div>
