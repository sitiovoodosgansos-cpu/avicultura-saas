...
function CompactStatChip({
  ...
  return (
    <div className="flex h-[96px] w-full min-w-0 flex-col items-center justify-center rounded-xl bg-slate-50 px-2 py-1.5 text-center">
      ...
      <p className="mt-1 text-[38px] font-semibold leading-none text-slate-900">{value}</p>
    </div>
  );
}
            ...
            <Card key={group.id} className="h-fit overflow-hidden">
              <div className="flex flex-col gap-4 2xl:flex-row 2xl:items-start 2xl:justify-between">
                <div className="flex-1">
                  ...
                  <div className="mt-4 grid w-full grid-cols-2 gap-2 sm:grid-cols-3 xl:grid-cols-4">
